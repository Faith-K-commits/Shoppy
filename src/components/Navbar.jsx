    ...
    return (
        <div className='flex justify-between p-2 md:mx-6 relative'>
            ...
            <div className="flex">
                ...
                <NavButton title="Chart" dotColor="#03C9D7" customFunc={() =>
                    handleClick('chart')
                ...
                <TooltipComponent content="Profile" position="BottomCenter">
                    <div className="flex-items-center gap-2 cursor-center p-1 hover:bg-light-gray rounded-lg" onClick={() => handleClick('userProfile')}>
